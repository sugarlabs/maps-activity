...
class Map(activity.Activity):
    ...
    def _initme(self, userdata=None):
        ...
        buttNorthFiller.modify_bg(Gtk.StateType.NORMAL, Constants.color_bg.g_color)
        buttNorthFiller.modify_bg(Gtk.StateType.ACTIVE, Constants.color_bg.g_color)
        buttNorthFiller.modify_bg(Gtk.StateType.INSENSITIVE, Constants.color_bg.g_color)
        vboxNorth.pack_start(buttNorthFiller, True, True, 0)
        buttNorthEventBox = Gtk.EventBox()
        buttNorthEventBox.modify_bg(Gtk.StateType.NORMAL, Constants.color_bg.g_color)
        buttNorthEventBox.modify_bg(Gtk.StateType.ACTIVE, Constants.color_bg.g_color)
        buttNorthEventBox.modify_bg(Gtk.StateType.INSENSITIVE, Constants.color_bg.g_color)
        self.buttNorth = Gtk.Button()
        self.buttNorth.set_property("can-focus", False)
        self.buttNorth.modify_bg(Gtk.StateType.NORMAL, Constants.color_bg.g_color)
        self.buttNorth.modify_bg(Gtk.StateType.ACTIVE, Constants.color_bg.g_color)
        self.buttNorth.modify_bg(Gtk.StateType.INSENSITIVE, Constants.color_bg.g_color)
        ...
        buttSouthEventBox.modify_bg(Gtk.StateType.ACTIVE, Constants.color_bg.g_color)
        buttSouthEventBox.modify_bg(Gtk.StateType.NORMAL, Constants.color_bg.g_color)
        buttSouthEventBox.modify_bg(Gtk.StateType.INSENSITIVE, Constants.color_bg.g_color)
        vboxSouth.pack_start(buttSouthEventBox, False, False, 0)
        self.buttSouth = Gtk.Button()
        self.buttSouth.set_property("can-focus", False)
        self.buttSouth.modify_bg(Gtk.StateType.NORMAL, Constants.color_bg.g_color)
        self.buttSouth.modify_bg(Gtk.StateType.ACTIVE, Constants.color_bg.g_color)
        self.buttSouth.modify_bg(Gtk.StateType.INSENSITIVE, Constants.color_bg.g_color)
        ...
        buttSouthFiller.modify_bg(Gtk.StateType.NORMAL, Constants.color_bg.g_color)
        buttSouthFiller.modify_bg(Gtk.StateType.ACTIVE, Constants.color_bg.g_color)
        buttSouthFiller.modify_bg(Gtk.StateType.INSENSITIVE, Constants.color_bg.g_color)
        ...
        fakeTrayEvent.modify_bg(Gtk.StateType.NORMAL, Constants.color_bg.g_color)
        ...
        buttWestFiller.modify_bg(Gtk.StateType.ACTIVE, Constants.color_bg.g_color)
        buttWestFiller.modify_bg(Gtk.StateType.NORMAL, Constants.color_bg.g_color)
        buttWestFiller.modify_bg(Gtk.StateType.INSENSITIVE, Constants.color_bg.g_color)
        ...
        buttWestEventBox.modify_bg(Gtk.StateType.NORMAL, Constants.color_bg.g_color)
        buttWestEventBox.modify_bg(Gtk.StateType.ACTIVE, Constants.color_bg.g_color)
        buttWestEventBox.modify_bg(Gtk.StateType.INSENSITIVE, Constants.color_bg.g_color)
        self.buttWest = Gtk.Button()
        self.buttWest.set_property("can-focus", False)
        buttWestEventBox.add(self.buttWest)
        self.buttWest.modify_bg(Gtk.StateType.NORMAL, Constants.color_bg.g_color)
        self.buttWest.modify_bg(Gtk.StateType.ACTIVE, Constants.color_bg.g_color)
        self.buttWest.modify_bg(Gtk.StateType.INSENSITIVE, Constants.color_bg.g_color)
        ...
        self.browser.set_size_request(int(web_width * self.htmlScale), int(webHeight*self.htmlScale))
        self.browseBox.pack_start(self.browser, True, True, 0)
        self.browseBox.set_size_request(int(web_width * self.htmlScale), int(webHeight*self.htmlScale))
        ...
        buttEastEventBox.modify_bg(Gtk.StateType.ACTIVE, Constants.color_bg.g_color)
        buttEastEventBox.modify_bg(Gtk.StateType.NORMAL, Constants.color_bg.g_color)
        buttEastEventBox.modify_bg(Gtk.StateType.INSENSITIVE, Constants.color_bg.g_color)
        self.buttEast = Gtk.Button()
        self.buttEast.set_property("can-focus", False)
        self.buttEast.modify_bg(Gtk.StateType.ACTIVE, Constants.color_bg.g_color)
        self.buttEast.modify_bg(Gtk.StateType.NORMAL, Constants.color_bg.g_color)
        self.buttEast.modify_bg(Gtk.StateType.INSENSITIVE, Constants.color_bg.g_color)
        ...
        buttEastFiller.modify_bg(Gtk.StateType.ACTIVE, Constants.color_bg.g_color)
        buttEastFiller.modify_bg(Gtk.StateType.NORMAL, Constants.color_bg.g_color)
        buttEastFiller.modify_bg(Gtk.StateType.INSENSITIVE, Constants.color_bg.g_color)
        ...
        self.browser.load_uri("file://" + self.htmlPath + "/staticmap2.html?ajaxPort=" + str(self.__class__.ajaxPort) + "&cometPort=" + str(self.__class__.cometPort) + "&xo=true" + "&lat=" + str(self.NOW_MAP_CENTER_LAT) + "&lng=" + str(self.NOW_MAP_CENTER_LNG) + "&zoom=" + str(self.NOW_MAP_ZOOM) + "&type=" + self.__class__.initType + "&" + Constants.istr_lang)

        self.loaded = True
        self.loadingWindow = Gtk.Window()
        self.addToWindowStack(self.loadingWindow, self)
        self.loadingWindow.modify_bg(Gtk.StateType.NORMAL, Constants.color_black.g_color)
        loadingVBox = Gtk.VBox()
        self.loadingWindow.add(loadingVBox)

        loadingTopEventBox = Gtk.EventBox()
        loadingTopEventBox.modify_bg(Gtk.StateType.NORMAL, Constants.color_black.g_color)
        loadingVBox.pack_start(loadingTopEventBox, True, True, 0)

        self.loadingCanvas = PhotoCanvas()
        self.loadingCanvas.modify_bg(Gtk.StateType.NORMAL, Constants.color_black.g_color)
        ...
        loadingInfo.set_markup("<b><span foreground='white' size='xx-large'>" + Constants.istr_connecting + "</span></b>")
        loadingVBox.pack_start(loadingInfo, False, False, 0)

        loadingBotEventBox = Gtk.EventBox()
        loadingBotEventBox.modify_bg(Gtk.StateType.NORMAL, Constants.color_black.g_color)
        loadingVBox.pack_start(loadingBotEventBox, True, True, 0)
        self.loadingWindow.resize(Gdk.Screen.width(), Gdk.Screen.height() - self.toolbarbox.get_allocation().height)
        self.moveWinOffscreen(self.loadingWindow)

        self.popWindow = Gtk.Window()
        self.addToWindowStack(self.popWindow, self.loadingWindow)
        self.popWindow.modify_bg(Gtk.StateType.NORMAL, Constants.color_black.g_color)
        ...
        self.selectWindow.modify_bg(Gtk.StateType.NORMAL, Constants.color_black.g_color)
        ...
        self.toolbarbox_SIZE_ALLOCATE_ID = self.toolbarbox.connect_after("size-allocate", self._sizeAllocateCb)
        self.show_all()
    ...
    def showFileLoadBlocker(self, show):
        if (show):
            ...
            self.smartResize(self.selectWindow, Gdk.Screen.width(), Gdk.Screen.height())
        else:
            self.moveWinOffscreen(self.selectWindow)
    ...
    def _sizeAllocateCb(self, widget, event):
        ...
        self.smartMove(self.loadingWindow, 0, self.toolbarbox.get_allocation().height)
        self.loadingWindow.resize(Gdk.Screen.width(), Gdk.Screen.height() - self.toolbarbox.get_allocation().height)
        return False
    ...
    def _saveSearch2(self):
        ...
        popScreenshot = Gdk.pixbuf_get_from_window(self.popWindow.get_window(), 0, 0, popW, popH);
        ...
        screenshotSmall = screenshot.scale_simple(smallWidth, smallHeight, GdkPixbuf.InterpType.NEAREST)
    ...
    def _fillInInfoWindow(self):
        ...
        rtButt.modify_bg(Gtk.StateType.INSENSITIVE, Constants.color_black.g_color)
    ...
    def showMedia(self, id, x, y, up, rt):
        ...
        self.mediaWindow.modify_bg(Gtk.StateType.NORMAL, recd.colorFill.g_color)
        if (recd.type == Constants.TYPE_PHOTO):
            ...
            self.photoCanvas.modify_bg(Gtk.StateType.NORMAL, recd.colorFill.g_color)
            ...
            self.gplayWin.modify_bg(Gtk.StateType.NORMAL, recd.colorFill.g_color)
            self.popWindow.hide()
            self.mediaWindow.show()
...
class AddToolbar(Gtk.Toolbar):
    ...
    def _webCb(self, button):
        self.ca.browser.load_uri("http://maptonomy.appspot.com/maps4xo?ajaxPort=" + str(self.ca.__class__.ajaxPort) + "&cometPort=" + str(self.ca.__class__.cometPort) + "&xo=true&lat=" + str(self.ca.NOW_MAP_CENTER_LAT) + "&lng=" + str(self.ca.NOW_MAP_CENTER_LNG) + "&z=" + str(self.ca.NOW_MAP_ZOOM) + "&" + Constants.istr_lang )
